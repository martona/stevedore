...
#   * exclusions     (bash array: one dataset per row -- sendtree drops
#                     each subtree from plan and manifest; generated by
#                     fleetrun from fleet.conf [exclusions])
...
transport="" tunnels=() retain_spec="" snapsbudget=() exclusions=()
